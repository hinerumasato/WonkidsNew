...
return [
    ...
    "wonkids-song-description"          => "bài hát chứa đựng chủ đề và những bài múa sôi động.",
    "wonkids-story"                     => "Câu chuyện Wonkids",
    "wonkids-story-description"         => "những câu chuyện sôi động về các nhân vật trong Kinh Thánh.",
    "wonkids-activities"                => "Hoạt động Wonkids",
    "wonkids-activities-description"    => "Giúp các em ứng dụng bài học bằng những phương pháp đa dạng.",
    "wonkids-bible"                     => "Câu gôc Wonkids",
    "wonkids-bible-description"         => "Giúp các em học thuộc câu gốc chủ đề một cách thú vị và dễ dàng.",
