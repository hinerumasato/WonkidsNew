                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3">
                                <input name="name" type="text" class="form-control @error('name') is-invalid @enderror" id="floatingText" placeholder="jhondoe">
                            ...
                            <div class="form-floating mb-4">
                                <input name="password_confirmation" type="password" class="form-control" id="floatingPasswordCofirmation" placeholder="Password">
                                <label for="floatingPasswordCofirmation">Nhập lại mật khẩu</label>
                            </div>

                            <div class="mb-3">
                                <label for="formFile" class="form-label">Tải ảnh đại diện lên</label>
