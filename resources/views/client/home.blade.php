...
@section('content')
    ...
    <div class="container mt-5">
        <div class="home_content row justify-content-between">
            <div class="col-5">
                <img class="w-100" src="{{ asset('imgs/banners/about_banner.png') }}" alt="">
            </div>
            <div class="col-6 home_about_content">
        ...
        <div class="home_content zones">
            ...
            <div class="row my-3">
                ...
                <div class="col-10 zones-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-3">
                    ...
                    <a href="{{ route('home.media.index') }}" class="text-uppercase media-all-link fw-bold mt-4">
                        <span class="me-2">@lang('general.see-all')</span>
                        <i class="fa-solid fa-right-long"></i>
                    </a>
                </div>

                <div class="col-9 wrapper d-flex justify-content-between">
    ...
    <div class="container contact mt-5">
        <div class="row justify-content-between">
            ...
            <div class="col-6 d-flex justify-content-center">
                <img width="400" height="300" src="{{ asset('imgs/contact/contact_img.png') }}" alt="">
            </div>
        </div>
    </div>
@endsection
